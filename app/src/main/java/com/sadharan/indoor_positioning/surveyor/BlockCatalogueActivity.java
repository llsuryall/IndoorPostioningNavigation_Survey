...
public class BlockCatalogueActivity extends AppCompatActivity implements View.OnClickListener, DialogInterface.OnClickListener, View.OnLongClickListener {
    ...
    private void initialize() {
        ...
        long temp = getIntent().getLongExtra(getString(R.string.building_id_field), -1);
        if (temp >= 0) {
            this.blockCatalogueViewModel.setBuilding_id(temp);
        }
        this.building_id = this.blockCatalogueViewModel.building_id;
